...
public class MusicPlayer extends PlaybackListener {
    ...
    //make sure that the song is finished
    private boolean songFinished;

    private boolean nextPressed, prevPressed;

    //stores frame of song currently paused at
    ...
    public void loadPlaylist(File playlistFile){
        ...
        //store the paths from the text file to the playlist array list
        try{

            FileReader fileReader = new FileReader(playlistFile);
            BufferedReader bufferedReader = new BufferedReader(fileReader);

            //read each line from the text file and store the text into a songPath variable
            String songPath;
            while((songPath = bufferedReader.readLine()) != null){
                //create song object based on the song path
        ...
        if(playlist.size()>0){
            ...
            //update current song to the first sonf in the playlist
    ...
    public void nextSong(){
        //no need to go to the next sonf if there is no playlist
        if(playlist == null) return;

        nextPressed = true;

        //if end of playlist then don't do anything
    ...
    public void prevSong(){
        ...
        //check if beginning then do nothing
        //if end of playlist then don't do anything
            ...
            public void run() {
                ...
                if(isPaused){
                    try{
                        ...
                        //makes sure that is paused boolean flag is updated to false before continuing
                ...
                while(!isPaused && !songFinished && !nextPressed && !prevPressed){
                    try{
                        ...
                        //mimic 1 millisecond using thread to sleep
                        Thread.sleep(1);
    ...
    public void playbackFinished(PlaybackEvent evt) {
        //this method gets called after the song finished or if the player closes
        ...
        if(isPaused){
            ...
            //if next or previous is pressed, we don't need to execute the rest of the code
